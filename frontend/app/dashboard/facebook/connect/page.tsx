...
import {
  MessageSquare, Eye, EyeOff, Save, AlertCircle, Loader2,
...
export default function FacebookConnectPage() {
  ...
  const channelHealth = webhookHealth?.health?.facebook;
  const tokenAlert = webhookHealth?.token_alerts?.find(a => a.channel === "facebook");

  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="page-title">Connect Facebook</h1>
          <p className="page-subtitle">Configure page IDs and access tokens for Facebook Messenger Messaging.</p>
        </div>
          ...
          <div className="card rounded-3xl p-6 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-body text-xs text-ink-muted">Enter Page ID and Facebook Access Token.</p>
              </div>
            </div>
