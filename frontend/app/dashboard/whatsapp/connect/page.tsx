...
export default function WhatsAppConnectPage() {
  ...
  const channelHealth = webhookHealth?.health?.whatsapp;
  const tokenAlert = webhookHealth?.token_alerts?.find(a => a.channel === "whatsapp");
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-subtitle">Configure credentials and subscribe to webhook events.</p>
        </div>
          ...
          <div className="card rounded-3xl p-6 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-body text-xs text-ink-muted">Enter API IDs and Permanent Token.</p>
              </div>
            </div>
