...
async def send_whatsapp(to_phone: str, message: str, tenant_id: str | None = None, lead_id: str | None = None) -> str | None:
    ...
    try:
        ...
        data = await send_text_message(to_number=to_phone, text=message, tenant_id=tenant_id, lead_id=lead_id)
...
async def generate_reply(
    ...
    if channel == "instagram":
        ...
        sid = await send_whatsapp(phone, reply_text, tenant_id=lead_data.get("tenant_id"), lead_id=str(lead_id)) if phone else None
